...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Book', path: '/books', entity: 'book', service: AccessServiceEnum.PROJECT, icon: FiBook },
    {
      name: 'Book Owner',
      path: '/book-owners',
      entity: 'book_owner',
    ...
    { name: 'Interest', path: '/interests', entity: 'interest', service: AccessServiceEnum.PROJECT, icon: FiHeart },
